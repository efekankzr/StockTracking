...
namespace StockTracking.WebAPI.Controllers
{
    ...
    public class TransferController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            {
                return BadRequest(ServiceResponse<object>.Fail("Kullanıcının deposu bulunamadı."));
            }
        ...
        public async Task<IActionResult> Create(CreateTransferDto request)
        {
            ...
            if (User.IsInRole("DepoSorumlusu"))
            {
                ...
                {
                    return BadRequest(ServiceResponse<bool>.Fail("Sadece sorumlu olduğunuz depodan transfer başlatabilirsiniz."));
                }
            }
