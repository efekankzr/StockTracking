  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-slate-800">Gider Fişleri</h2>
      ...
      <Card>
        <CardHeader><CardTitle>Gider Listesi</CardTitle></CardHeader>
        <CardContent>
            <Table>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    {data?.data?.length === 0 ? (
                        <TableRow><TableCell colSpan={10} className="text-center h-24 text-gray-500">Kayıt yok.</TableCell></TableRow>
                    ) : (
                        data?.data.map((item) => (
